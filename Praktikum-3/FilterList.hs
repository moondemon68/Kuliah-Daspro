...
-- Deskripsi: memfilter bilangan dalam list
...
module FilterList where
    ...
    -- melakukan “filter” atau penyaringan terhadap elemen list of integer dan menghasilkan list baru dengan elemen yang 
    -- lolos kriteria filter.
    isPos::Int->Bool
