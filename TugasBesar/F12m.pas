...
implementation
    ...
    begin
		...
		begin
			if stringCompare(lBuku.list[i].kategori, 'sastra') then begin jlh_sastra+=1; end;
			if stringCompare(lBuku.list[i].kategori, 'sains') then begin jlh_sains+=1; end;
			if stringCompare(lBuku.list[i].kategori, 'manga') then begin jlh_manga+=1; end;
			if stringCompare(lBuku.list[i].kategori, 'sejarah') then begin jlh_sejarah+=1; end;
			if stringCompare(lBuku.list[i].kategori, 'programming') then begin jlh_programming+=1; end;
		end;
